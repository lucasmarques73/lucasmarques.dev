      ...
      <div className="max-w-screen-xl flex flex-wrap items-center justify-evenly mx-auto p-8">
        ...
        <div className="w-full md:block md:w-auto hidden" id="navbar-solid-bg">
          <ul className="flex flex-col font-medium mt-4 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-transparent ">
            <li>
              <a href="/blog" className="block py-2 px-3 md:p-0">
                Blog
              </a>
            </li>
            <li>
            ...
            <li>
              <a href="/about" className="block py-2 px-3 md:p-0">
                CV
              </a>
            </li>
            <li>
              <a
                href="/assets/resume/lucas-marques.en.pdf"
                download
        ...
        <div
          className={`${collapsed ? "hidden" : ""} w-full`}
          id="navbar-hamburger"
        >
          <ul className="flex flex-col font-medium mt-4 rounded-lg">
            <li>
              <a href="/blog" className="block py-2 px-3">
                Blog
              </a>
            </li>
            <li>
